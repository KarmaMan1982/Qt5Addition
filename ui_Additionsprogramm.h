...
public:
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Additionsprogramm", 0));
        lbSummand1->setText(QApplication::translate("MainWindow", "Erster Summand", 0));
        lbSummand2->setText(QApplication::translate("MainWindow", "Zweiter Summand", 0));
        lbSumme->setText(QApplication::translate("MainWindow", "Summe", 0));
        btAddition->setText(QApplication::translate("MainWindow", "Zusammenz\303\244hlen", 0));
        Q_UNUSED(MainWindow);
    } // retranslateUi
